    ...
    controller = new Hono()
        ...
        .get(
            ...
            describeRoute({
                ...
                description: "Returnează notificările paginate. Suportă filtrare după unreadOnly.",
                tags: ["Notifications"],
                responses: {
                    200: { description: "Lista paginată de notificări și unreadCount" },
                    401: { description: "Neautorizat (lipsește sesiunea sau X-Guest-Session)" },
                },
            }),
        ...
        .patch(
            ...
            describeRoute({
                ...
                description: "Setează readAt la momentul curent pentru toate notificările necitite.",
                tags: ["Notifications"],
                responses: {
            ...
            async (c) => {
                ...
                const count = await this.notificationRepo.markAllAsRead({ userId, guestSessionId });
        ...
        .patch(
            ...
            describeRoute({
                ...
                description: "Setează readAt la momentul curent pentru notificarea specificată.",
                tags: ["Notifications"],
                responses: {
            ...
            async (c) => {
                ...
                const isOwner = (userId && notification.userId === userId) || 
                                (guestSessionId && notification.guestSessionId === guestSessionId);
                
                if (!isOwner) {
                    return c.json({ error: "Forbidden: You don't own this notification" }, 403);
                }
        ...
        .get(
            ...
            describeRoute({
                ...
                description: "Nu se apelează via REST (Swagger). Conectați-vă cu un client WS. Dacă sunteți guest, folosiți parametrul de query ?guestSessionId=...",
                tags: ["Notifications"],
            }),
            upgradeWebSocket((c) => {
                return {
